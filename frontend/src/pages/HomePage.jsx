    ...
    <div 
      ...
      style={{
        ...
        boxShadow: tilt.x === 0 && tilt.y === 0 
          ? '0 20px 50px rgba(42,54,43,0.02)'
          : '0 30px 60px rgba(42,54,43,0.08), 0 0 30px rgba(42, 54, 43, 0.01)',
      }}
    >
...
function CareerPaths() {
  const categories = [
    { name: 'Data Science', icon: Brain, count: 85, color: '#CBBBA0' },
    { name: 'AI / Machine Learning', icon: Cpu, count: 62, color: '#CBBBA0' },
    { name: 'Data Analytics', icon: BarChart3, count: 104, color: '#CBBBA0' },
    { name: 'Business Intelligence', icon: TrendingUp, count: 78, color: '#CBBBA0' },
    { name: 'Software Engineering', icon: Code2, count: 156, color: '#CBBBA0' },
    { name: 'Data Engineering', icon: Database, count: 54, color: '#CBBBA0' },
  ]
  return (
    <section className="py-20 relative">
      <div className="container-app">
      ...
      <section id="profile-terminal" className="py-20 relative z-10 border-t border-white/[0.03] bg-void/10">
        <div className="container-app max-w-3xl">
          ...
          <motion.div 
            ...
            className="w-full rounded-2xl border border-black/[0.04] bg-white/80 backdrop-blur-xl shadow-[0_20px_50px_rgba(42,54,43,0.02)] overflow-hidden"
          >
